...
context SeleniumConfiguration do
  setup do
    ...
    @configuration = SeleniumrcFu::SeleniumConfiguration.instance
  ...
  specify "establish_environment__browsers" do
    ...
    SeleniumrcFu::SeleniumConfiguration.send :establish_environment
  ...
  specify "browsers__lazy_loaded" do
    should_lazily_load @configuration, :browsers, [SeleniumrcFu::SeleniumConfiguration::FIREFOX]
  end
  ...
  specify "formatted_browser" do
    @configuration.current_browser = SeleniumrcFu::SeleniumConfiguration::IEXPLORE
  ...
  def should_establish_environment( env_var, expected_value, method_name=nil )
    ...
    stub_env[env_var] = expected_value
    SeleniumrcFu::SeleniumConfiguration.send :establish_environment
    SeleniumrcFu::SeleniumConfiguration.instance.send(method_name).should == expected_value
  end
